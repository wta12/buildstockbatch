...
latex_documents = [
    (master_doc, 'BuildStockBatch.tex', 'BuildStock Batch Documentation',
     'Noel Merket (NREL)', 'manual'),
]
...
man_pages = [
    (master_doc, 'buildstockbatch', 'BuildStock Batch Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'BuildStockBatch', 'BuildStock Batch Documentation',
     author, 'BuildStockBatch', 'One line description of project.',
     'Miscellaneous'),
]
